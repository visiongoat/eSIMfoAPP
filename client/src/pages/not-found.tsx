    ...
    <div className="mobile-screen flex flex-col items-center justify-center p-6 text-center">
      ...
      <div className="space-y-3 w-full max-w-sm">
        ...
        <button
          ...
          className="w-full bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white py-4 rounded-2xl font-semibold transition-all duration-200 hover:bg-gray-200 dark:hover:bg-gray-700 active:scale-[0.98]"
        >
          Go Back
        </button>
      </div>
