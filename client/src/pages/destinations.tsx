            ...
            {selectedTab === 'countries' ? (
              ...
              finalFilteredData.map((country: any, index: number) => (
                <button
                  ...
                  style={{ animationDelay: `${index * 50}ms` }}
                  className="w-full bg-gradient-to-br from-white via-blue-50/20 to-gray-50/40 dark:bg-gradient-to-r dark:from-gray-800 dark:via-gray-750/30 dark:to-gray-800 py-4 px-4 rounded-2xl text-left hover:bg-gradient-to-br hover:from-blue-50/60 hover:via-white hover:to-purple-50/30 dark:hover:bg-gradient-to-r dark:hover:from-gray-700/70 dark:hover:via-gray-600/70 dark:hover:to-gray-700/70 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 active:scale-[0.98] group animate-fadeInUp border border-transparent hover:border-blue-500/20 dark:hover:border-blue-400/20"
                >
