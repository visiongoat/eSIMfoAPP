            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <button
                  key={index}
                  onClick={() => handleCountrySelect(countries[0])}
                  className="bg-white/80 backdrop-blur-sm rounded-xl p-3 text-left shadow-sm border border-gray-100/50 hover:shadow-md transition-all hover:scale-[1.02] active:scale-[0.98] duration-200"
                >
                  <div className="flex items-center space-x-3">
