          ...
          <div className="mb-4 pb-4 -mx-3 sm:-mx-4 -mt-3 sm:-mt-4 px-3 sm:px-4 pt-3 sm:pt-4 bg-gradient-to-r from-blue-100/60 via-indigo-50/40 to-purple-100/50 dark:from-blue-900/30 dark:via-indigo-900/20 dark:to-purple-900/30 border-b border-blue-100/50 dark:border-gray-700 relative">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <svg className="w-4 h-4 text-gray-600 dark:text-gray-400" viewBox="0 0 24 24" fill="currentColor"><path d="M1.5 0C.67 0 0 .7 0 1.56v20.88C0 23.3.67 24 1.5 24h20.99c.83 0 1.51-.7 1.51-1.56V1.56C24 .7 23.32 0 22.49 0zm5.1 6.16h2.84c1.68 0 2.73.92 2.73 2.37a2.1 2.1 0 0 1-1.22 1.98 2.26 2.26 0 0 1 1.58 2.22c0 1.6-1.14 2.6-2.96 2.6H6.6zm2.6 3.68c.74 0 1.17-.36 1.17-.97s-.43-.97-1.17-.97H8.24v1.94zm.2 3.9c.82 0 1.3-.4 1.3-1.07s-.48-1.07-1.3-1.07H8.24v2.14z"/></svg>
