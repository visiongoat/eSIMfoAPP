                  ...
                  <button 
                    ...
                    className={`w-full p-2.5 rounded-xl border-2 transition-all duration-300 shadow-lg hover:shadow-xl relative ${
                      selectedEuropaPlan === plan.id
                        ...
                        : plan.id === 4 
                          ? 'popular-card-border bg-gradient-to-r from-amber-50 via-yellow-50 to-transparent dark:from-amber-900/20 dark:via-yellow-900/20 dark:to-transparent hover:scale-[1.01] hover:transform hover:translate-y-[-3px]'
