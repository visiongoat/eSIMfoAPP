        ...
        >
          ...
          >
            ...
            <div className="px-6 pb-5 pt-2">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2 text-center">Get Support</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm text-center leading-relaxed">
                Choose your preferred channel
              </p>
            </div>

            {/* Support Options - Premium Design */}
            <div className="px-4 space-y-3 mb-4">
              {/* In-app Chat - Premium Card */}
              <button 
                onClick={() => {
                  setShowQuickActions(false);
                  setShowInAppSupport(true);
                }}
                className="w-full bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 backdrop-blur-sm rounded-2xl p-4 border border-orange-100 dark:border-orange-800/50 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 group"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div className="w-11 h-11 bg-gradient-to-br from-orange-400 to-red-500 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400">Instant support in app</p>
                    </div>
                  </div>
                  <svg className="w-5 h-5 text-orange-500 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </div>
              </button>

              {/* WhatsApp Support - Premium Card */}
              <button 
                onClick={() => {
                  setShowQuickActions(false);
                  window.open(`https://wa.me/436766440122`, '_blank');
                }}
                className="w-full bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 backdrop-blur-sm rounded-2xl p-4 border border-green-100 dark:border-green-800/50 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 group"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div className="w-11 h-11 bg-gradient-to-br from-green-400 to-emerald-500 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400">Message us anytime</p>
                    </div>
                  </div>
                  <svg className="w-5 h-5 text-green-500 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </div>
              </button>
            ...
            <div className="px-4 pb-5">
              <button 
                onClick={() => setShowQuickActions(false)}
                className="w-full py-3.5 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl text-gray-700 dark:text-gray-300 font-semibold transition-all duration-200 hover:bg-white dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-700"
              >
                Cancel
              </button>
            </div>
