          ...
          >
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">1 GB • 7 Days • Global</p>
              </div>
              <button
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-gradient-to-r from-purple-50 to-indigo-50 dark:bg-gray-700/50 rounded-xl border border-purple-100 dark:border-gray-600 shadow-sm">
                    <div className="flex items-center space-x-3">
                      <svg className="w-4 h-4 text-purple-600 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                      </svg>
                      <span className="text-sm text-gray-700 dark:text-gray-400 font-medium">Package Type</span>
                    </div>
                    <span className="font-semibold text-purple-700 dark:text-white">global</span>
                  </div>
                  
                  <div className="flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 to-cyan-50 dark:bg-gray-700/50 rounded-xl border border-blue-100 dark:border-gray-600 shadow-sm">
                    <div className="flex items-center space-x-3">
                      <svg className="w-4 h-4 text-blue-600 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4" />
                      </svg>
                      <span className="text-sm text-gray-700 dark:text-gray-400 font-medium">Data Allowance</span>
                    </div>
                    <span className="font-semibold text-blue-700 dark:text-white">1 GB</span>
                  </div>
                  
                  <div className="flex items-center justify-between p-3 bg-gradient-to-r from-amber-50 to-orange-50 dark:bg-gray-700/50 rounded-xl border border-amber-100 dark:border-gray-600 shadow-sm">
                    <div className="flex items-center space-x-3">
                      <svg className="w-4 h-4 text-amber-600 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="text-sm text-gray-700 dark:text-gray-400 font-medium">Validity Period</span>  
                    </div>
                    <span className="font-semibold text-amber-700 dark:text-white">7 days</span>
                  </div>
                  
                  <div className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-50 to-teal-50 dark:bg-gray-700/50 rounded-xl border border-emerald-100 dark:border-gray-600 shadow-sm">
                    <div className="flex items-center space-x-3">
                      <svg className="w-4 h-4 text-emerald-600 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                      </svg>
                      <span className="text-sm text-gray-700 dark:text-gray-400 font-medium">Price</span>
                    </div>
                    <span className="font-semibold text-emerald-700 dark:text-white">€4.61</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-gradient-to-r from-indigo-50 to-blue-50 dark:bg-gray-700/50 rounded-xl border border-indigo-100 dark:border-gray-600 shadow-sm">
                    <div className="flex items-center space-x-3">
                      <svg className="w-4 h-4 text-indigo-600 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.111 16.404a5.5 5.5 0 017.778 0M12 20h.01m-7.08-7.071c3.904-3.905 10.236-3.905 14.141 0M1.394 9.393c5.857-5.857 15.355-5.857 21.213 0" />
                      </svg>
                      <span className="text-sm text-gray-700 dark:text-gray-400 font-medium">Network Technology</span>
                    </div>
                    <span className="font-semibold text-indigo-700 dark:text-white">5G Ready, LTE/4G</span>
                  </div>
                  
                  <div className="flex items-center justify-between p-3 bg-gradient-to-r from-green-50 to-emerald-50 dark:bg-gray-700/50 rounded-xl border border-green-100 dark:border-gray-600 shadow-sm">
                    <div className="flex items-center space-x-3">
                      <svg className="w-4 h-4 text-green-600 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="text-sm text-gray-700 dark:text-gray-400 font-medium">Roaming Support</span>
                    </div>
                    <span className="font-semibold text-green-700 dark:text-green-400">Enabled</span>
                  </div>
                  
                  <div className="flex items-center justify-between p-3 bg-gradient-to-r from-yellow-50 to-amber-50 dark:bg-gray-700/50 rounded-xl border border-yellow-100 dark:border-gray-600 shadow-sm">
                    <div className="flex items-center space-x-3">
                      <svg className="w-4 h-4 text-yellow-600 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                      </svg>
                      <span className="text-sm text-gray-700 dark:text-gray-400 font-medium">Activation Method</span>
                    </div>
                    <span className="font-semibold text-yellow-700 dark:text-white">Automatic</span>
                  </div>
                  
                  <div className="flex items-center justify-between p-3 bg-gradient-to-r from-rose-50 to-pink-50 dark:bg-gray-700/50 rounded-xl border border-rose-100 dark:border-gray-600 shadow-sm">
                    <div className="flex items-center space-x-3">
                      <svg className="w-4 h-4 text-rose-600 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                      </svg>
                      <span className="text-sm text-gray-700 dark:text-gray-400 font-medium">Protocol Support</span>
                    </div>
                    <span className="font-semibold text-rose-700 dark:text-white">IPv4/IPv6</span>
                  </div>
                </div>
              </div>
            </div>
