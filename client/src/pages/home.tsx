        ...
        >
          ...
          >
            ...
            <div className="px-6 pb-4 pt-2">
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-1.5 text-center">Get Support</h2>
              <p className="text-gray-500 dark:text-gray-400 text-sm text-center">
                Choose your preferred channel
              </p>
            </div>

            {/* Support Options - Compact Premium */}
            <div className="px-5 space-y-2.5 mb-4">
              {/* Live Chat - Compact Card */}
              <button 
                onClick={() => {
                  setShowQuickActions(false);
                  setShowInAppSupport(true);
                }}
                className="w-full bg-orange-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-2xl p-3.5 hover:shadow-md hover:scale-[1.01] transition-all duration-200 group"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3.5">
                    <div className="w-12 h-12 bg-gradient-to-br from-orange-400 to-orange-500 rounded-2xl flex items-center justify-center shadow-sm group-hover:scale-105 transition-transform duration-200">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                      </svg>
                    </div>
                    <div className="text-left">
                      <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-0.5">Live Chat</h3>
                      <p className="text-xs text-gray-500 dark:text-gray-400">Instant support in app</p>
                    </div>
                  </div>
                  <svg className="w-5 h-5 text-orange-500 group-hover:translate-x-0.5 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button 
                ...
                className="w-full bg-green-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl p-3.5 hover:shadow-md hover:scale-[1.01] transition-all duration-200 group"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3.5">
                    <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center shadow-sm group-hover:scale-105 transition-transform duration-200">
                    ...
                    <div className="text-left">
                      <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-0.5">WhatsApp</h3>
                      <p className="text-xs text-gray-500 dark:text-gray-400">Message us anytime</p>
                    </div>
                  </div>
                  <svg className="w-5 h-5 text-green-500 group-hover:translate-x-0.5 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" />
                  </svg>
                </div>
              </button>
            ...
            <div className="px-5 pb-4 pt-1">
              <button 
                onClick={() => setShowQuickActions(false)}
                className="w-full py-3.5 bg-white dark:bg-gray-800 rounded-2xl text-gray-600 dark:text-gray-300 font-semibold transition-all duration-200 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700"
              >
                Cancel
              </button>
            </div>
