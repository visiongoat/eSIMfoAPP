        ...
        {selectedTab === 'local' ? (
          ...
          <div className="space-y-3 animate-slide-in-left" key="global-plans">
            ...
            <div className="text-center mb-3">
              ...
              {/* Functional Button Pair */}
              <div className="flex items-center justify-center space-x-2 mt-2">
                <button 
                  onClick={() => setShowCountriesModal(true)}
                  className="flex items-center space-x-1.5 px-3 py-1.5 bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/30 dark:hover:bg-blue-900/50 border border-blue-200 dark:border-blue-700 rounded-lg transition-all duration-200 hover:shadow-sm active:scale-95"
                >
                  <svg className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="text-xs font-semibold text-blue-700 dark:text-blue-300">Coverage 137 Countries</span>
                </button>
                
                <button 
                  onClick={() => setShowPlanInfoModal(true)}
                  className="flex items-center space-x-1.5 px-3 py-1.5 bg-orange-50 hover:bg-orange-100 dark:bg-orange-900/30 dark:hover:bg-orange-900/50 border border-orange-200 dark:border-orange-700 rounded-lg transition-all duration-200 hover:shadow-sm active:scale-95"
                >
                  ...
                  <span className="text-xs font-semibold text-orange-700 dark:text-orange-300">Global Plan Features</span>
                </button>
              </div>
            </div>
