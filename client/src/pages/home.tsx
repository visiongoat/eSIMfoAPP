          ...
          <div className="max-w-screen-md mx-auto">
            <div className="flex items-center space-x-3">
              ...
              <div className="relative flex-1 group">
                <svg className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-blue-500 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
