          ...
          <div className="mb-4 pb-4 -mx-3 sm:-mx-4 -mt-3 sm:-mt-4 px-3 sm:px-4 pt-3 sm:pt-4 bg-gradient-to-r from-blue-100/60 via-indigo-50/40 to-purple-100/50 dark:from-blue-900/30 dark:via-indigo-900/20 dark:to-purple-900/30 border-b border-blue-100/50 dark:border-gray-700 relative">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <svg className="w-4 h-4 text-gray-600 dark:text-gray-400" viewBox="0 0 24 24" fill="currentColor"><path d="M12.001 16.639c-.753-.558-4.56-3.391-5.872-5.78-.628-1.144-.708-2.276-.396-3.207.315-.943.98-1.652 1.868-1.652.743 0 1.44.39 2.038.96l.166.166c.62.62 1.232 1.356 2.196 1.356.964 0 1.576-.736 2.196-1.356l.166-.166c.598-.57 1.295-.96 2.038-.96.888 0 1.553.709 1.868 1.652.312.931.232 2.063-.396 3.207-1.312 2.389-5.119 5.222-5.872 5.78zm0 3.407c-.44 0-.868-.17-1.232-.462-1.038-.832-6.769-5.396-6.769-10.484 0-2.156 1.564-3.1 2.868-3.1 1.144 0 2.156.52 3.133 1.42.977-.9 1.989-1.42 3.133-1.42 1.304 0 2.868.944 2.868 3.1 0 5.088-5.731 9.652-6.769 10.484-.364.292-.792.462-1.232.462z"/></svg>
