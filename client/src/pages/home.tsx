        ...
        {selectedTab === 'local' ? (
          ...
          <div className="space-y-3 animate-slide-in-left" key="global-plans">
            ...
            <div className="text-center mb-3">
              ...
              {/* Subtle Badge-Style Info Strip */}
              <div className="flex items-center justify-center space-x-3 mt-2">
                <button 
                  onClick={() => setShowCountriesModal(true)}
                  className="group flex items-center space-x-2 px-3 py-1 bg-transparent hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-full transition-all duration-200 active:scale-95"
                >
                  <div className="flex items-center space-x-1">
                    <div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div>
                    <span className="text-xs font-medium text-gray-600 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400">137 Countries</span>
                  </div>
                  <svg className="w-3 h-3 text-gray-400 group-hover:text-blue-500 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </button>
                
                <div className="w-0.5 h-3 bg-gray-300 dark:bg-gray-600 rounded-full"></div>
                
                <button 
                  onClick={() => setShowPlanInfoModal(true)}
                  className="group flex items-center space-x-2 px-3 py-1 bg-transparent hover:bg-orange-50 dark:hover:bg-orange-900/20 rounded-full transition-all duration-200 active:scale-95"
                >
                  <div className="flex items-center space-x-1">
                    <div className="w-1.5 h-1.5 bg-orange-500 rounded-full"></div>
                    <span className="text-xs font-medium text-gray-600 dark:text-gray-400 group-hover:text-orange-600 dark:group-hover:text-orange-400">Premium Features</span>
                  </div>
