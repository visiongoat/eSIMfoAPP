...
import { SiWhatsapp, SiTelegram, SiAirbnb, SiInstagram, SiTiktok } from "react-icons/si";
        ...
        <div className="mt-6 bg-gradient-to-br from-blue-50/80 via-white to-indigo-50/60 dark:from-gray-800 dark:via-gray-800 dark:to-blue-900/20 rounded-xl sm:rounded-2xl border border-blue-100/50 dark:border-gray-700 p-3 sm:p-4 relative">
          ...
          <div className="mb-4 pb-4 -mx-3 sm:-mx-4 -mt-3 sm:-mt-4 px-3 sm:px-4 pt-3 sm:pt-4 bg-gradient-to-r from-blue-100/60 via-indigo-50/40 to-purple-100/50 dark:from-blue-900/30 dark:via-indigo-900/20 dark:to-purple-900/30 relative rounded-t-xl sm:rounded-t-2xl">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-2">
                <SiWhatsapp className="w-4 h-4 text-gray-600 dark:text-gray-400" />
                <SiTelegram className="w-4 h-4 text-gray-600 dark:text-gray-400" />
