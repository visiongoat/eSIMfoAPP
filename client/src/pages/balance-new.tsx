...
export default function BalanceNewScreen() {
  ...
  const transactionHistory = [
    { id: 1, amount: 20.00, date: '2024-01-15', method: 'Credit Card', status: 'Completed' },
    { id: 2, amount: 50.00, date: '2024-01-10', method: 'PayPal', status: 'Completed' },
    { id: 3, amount: 15.00, date: '2024-01-05', method: 'Apple Pay', status: 'Completed' },
  ];
