        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-1.5 mb-4">
            {selectedTab === 'data-calls-text' ? (
              ...
              <>
                {/* Phone Number */}
                <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-2.5 text-center shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5">
                  <div className="w-6 h-6 mx-auto mb-1.5 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center">
                    <svg className="w-3.5 h-3.5 text-gray-600 dark:text-gray-300" viewBox="0 0 24 24" fill="currentColor">
              ...
              <>
                ...
                <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-2.5 text-center shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5">
                  ...
                  <div className="text-xs font-semibold text-gray-900 dark:text-white">T-Mobile</div>
                </div>
              </>
            )}
          </div>
                  ...
                  <div className="grid grid-cols-[1fr_auto] items-start gap-2">
                    ...
                    <DrawerClose asChild>
                      <button
                        ...
                        className="-mr-2 -mt-1 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                      >
