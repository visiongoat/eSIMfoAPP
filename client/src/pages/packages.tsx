  ...
  return (
    <div ref={containerRef} className="mobile-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-900 dark:text-white min-h-screen pb-20 animate-slide-in-from-top">
      ...
      {showPlanInfoModal && (
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-t-2xl w-full p-4 sm:p-6 space-y-4 sm:space-y-6 animate-slide-up">
            {/* Swipe Handle */}
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">{country?.name} eSIM Plan Details</p>
              </div>
              <button
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex items-center justify-between p-2.5 sm:p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                    <div className="flex items-center space-x-2 sm:space-x-3">
                      ...
                      <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Network Type</span>
                    </div>
                    <span className="font-semibold text-xs sm:text-sm text-gray-900 dark:text-white">4G/5G LTE</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-2.5 sm:p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                    <div className="flex items-center space-x-2 sm:space-x-3">
                      ...
                      <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Activation</span>
                    </div>
                    <span className="font-semibold text-xs sm:text-sm text-gray-900 dark:text-white">Instant</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-2.5 sm:p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                    ...
                    <span className="font-semibold text-xs sm:text-sm text-gray-900 dark:text-white">
                      {selectedTab === 'data-calls-text' ? 'Data + Voice + SMS' : 'Data Only'}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className="w-8 h-8 rounded-lg flex items-center justify-center">
                        <img src={country?.flagUrl || ''} alt={country?.name || ''} className="w-8 h-6 rounded shadow-sm" />
                      </div>
                      <div>
                        <div className="font-semibold text-gray-900 dark:text-gray-100 text-sm">{country?.name} Coverage</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">Local operators included</div>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="font-bold text-lg text-gray-900 dark:text-gray-100">1</div>
