...
Visit esimfo.com for global eSIM solutions!`;
  ...
  return (
    <div ref={containerRef} className={`mobile-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-900 dark:text-white min-h-screen ${selectedPackageForCheckout ? 'pb-52' : 'pb-20'} animate-slide-in-from-top transition-all duration-300`}>
      ...
      <div className="mx-4 mt-3 mb-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
          ...
          <div className="flex items-center justify-between border-b border-gray-200/80 dark:border-gray-700/40 pb-2.5">
            ...
            <div className="flex items-center space-x-1">
              ...
              <button
                ...
                className="px-2.5 py-1.5 text-xs font-semibold text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-900/20 hover:bg-orange-100 dark:hover:bg-orange-900/30 rounded-lg transition-colors active:scale-95"
              >
          ...
          <div className="flex items-center justify-between text-xs">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex items-end space-x-0.5">
                <div className="w-0.5 h-2 bg-gray-900 dark:bg-white rounded-full"></div>
                <div className="w-0.5 h-2.5 bg-gray-900 dark:bg-white rounded-full"></div>
                <div className="w-0.5 h-3 bg-gray-900 dark:bg-white rounded-full"></div>
                <div className="w-0.5 h-3.5 bg-gray-900 dark:bg-white rounded-full"></div>
              </div>
              {/* Carrier Name */}
            ...
            <div className="flex items-center space-x-2">
              <div className="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-1.5 py-0.5 rounded text-xs font-semibold">
                {(() => {
            ...
            <div className="flex items-center">
              {compatibilityResult ? (
                <div className={`flex items-center space-x-1 px-2 py-0.5 rounded-full text-xs font-medium ${
                  ...
                  <div className={`w-1.5 h-1.5 rounded-full ${compatibilityResult.isCompatible ? 'bg-green-500' : 'bg-red-500'}`}></div>
                  <span>{compatibilityResult.isCompatible ? 'Yes' : 'No'}</span>
                </div>
              ) : (
                <button
                  onClick={checkDeviceCompatibility}
                  className="px-2 py-0.5 text-xs font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-100 dark:hover:bg-blue-900/30 rounded-full transition-colors"
                >
                  Check now
                </button>
              )}
        ...
        <div className="border-t border-gray-200/50 dark:border-gray-700/50 bg-gray-50/50 dark:bg-gray-900/20">
          <div className="flex">
            <button
      ...
      <div className="px-4">
        ...
        {hasUnlimitedPlans && (
          <div className="mb-6 relative">
            <div className={`bg-gradient-to-r ${selectedPackage === 999 ? 'from-purple-600 via-blue-600 to-indigo-700 p-[2.5px] shadow-lg shadow-purple-500/15' : 'from-purple-500 via-blue-500 to-indigo-600 p-[2px] shadow-lg'} rounded-2xl transition-all duration-300`}>
              <div 
        ...
        <div className={`${selectedTab === 'data-calls-text' ? 'h-6' : 'h-4'}`}></div>
      </div>
      ...
      <div className="px-4 mt-3 pb-6">
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl border border-white/20 dark:border-gray-700/50 shadow-lg shadow-gray-200/20 dark:shadow-gray-900/20 overflow-hidden">
          ...
          <div className="p-4 space-y-3">
            {/* Contact Support - App Chat */}
            <button
              onClick={() => setLocation('/support')}
              className="w-full flex items-center justify-between p-3 bg-white dark:bg-gray-700/50 hover:bg-blue-50 dark:hover:bg-blue-950/30 rounded-xl border border-gray-200 dark:border-gray-600 transition-all duration-200 group"
            ...
            <button
              ...
              className="w-full flex items-center justify-between p-3 bg-white dark:bg-gray-700/50 hover:bg-green-50 dark:hover:bg-green-950/30 rounded-xl border border-gray-200 dark:border-gray-600 transition-all duration-200 group"
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  <div className="text-sm font-medium text-gray-900 dark:text-white">Chat on WhatsApp</div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">Quick messaging support</div>
                </div>
              </div>
