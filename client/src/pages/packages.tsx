    ...
    <div ref={containerRef} className="mobile-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-900 dark:text-white min-h-screen pb-20 animate-slide-in-from-top">
      ...
      <div className="px-4 mt-4">
        ...
        <div className="mb-6">
          ...
          {/* Corporate-style Quick Facts */}
          <div className="grid grid-cols-3 gap-3 mb-6">
            {selectedTab === 'data-calls-text' ? (
              // Data/Calls/Text packages: Phone Number - LTE Ready - No eKYC
              <>
                {/* Phone Number */}
                <div className="relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 group">
                  ...
                  <div className="relative p-4 text-center">
                    <div className="w-12 h-12 mx-auto mb-3 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M6.62,10.79C8.06,13.62 10.38,15.94 13.21,17.38L15.41,15.18C15.69,14.9 16.08,14.82 16.43,14.93C17.55,15.3 18.75,15.5 20,15.5A1,1 0 0,1 21,16.5V20A1,1 0 0,1 20,21A17,17 0 0,1 3,4A1,1 0 0,1 4,3H7.5A1,1 0 0,1 8.5,4C8.5,5.25 8.7,6.45 9.07,7.57C9.18,7.92 9.1,8.31 8.82,8.59L6.62,10.79Z"/>
                      </svg>
                    </div>
                    <div className="text-xs font-semibold text-gray-900 dark:text-white mb-1">Phone Number</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Voice & SMS</div>
                  </div>
                </div>
                ...
                <div className="relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 group">
                  ...
                  <div className="relative p-4 text-center">
                    <div className="w-12 h-12 mx-auto mb-3 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="text-xs font-semibold text-gray-900 dark:text-white mb-1">LTE Ready</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">4G/5G Network</div>
                  </div>
                </div>
                ...
                <div className="relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 group">
                  ...
                  <div className="relative p-4 text-center">
                    <div className="w-12 h-12 mx-auto mb-3 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12,1L3,5V11C3,16.55 6.84,21.74 12,23C17.16,21.74 21,16.55 21,11V5L12,1M12,7C13.4,7 14.8,8.6 14.8,10V11.5C15.4,11.5 16,12.4 16,13V16C16,17.4 15.4,18 14.8,18H9.2C8.6,18 8,17.4 8,16V13C8,12.4 8.6,11.5 9.2,11.5V10C9.2,8.6 10.6,7 12,7M12,8.2C11.2,8.2 10.5,8.7 10.5,10V11.5H13.5V10C13.5,8.7 12.8,8.2 12,8.2Z"/>
                      </svg>
                    </div>
                    <div className="text-xs font-semibold text-gray-900 dark:text-white mb-1">No eKYC</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Instant Setup</div>
                  </div>
                </div>
              </>
            ) : (
              ...
              <>
                ...
                <div className="relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 group">
                  ...
                  <div className="relative p-4 text-center">
                    ...
                    <div className="text-xs font-semibold text-gray-900 dark:text-white mb-1">US IP</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Local Address</div>
                  </div>
                </div>
              </>
            )}
