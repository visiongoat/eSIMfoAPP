...
function Router() {
  ...
  // Chat button visibility (hidden on splash, onboarding, live-chat, home, profile, and packages pages)
  const showChatButton = !['/', '/onboarding', '/live-chat', '/home', '/profile'].includes(location) && !location.startsWith('/packages');
