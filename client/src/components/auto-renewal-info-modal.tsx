          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-lg border border-gray-100 dark:border-gray-700">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="#f97316" className="flex-shrink-0 mt-0.5">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400 leading-tight">No need to set up a new SIM card every time, recharge your current one</p>
                </div>
              </div>

              <div className="flex items-start space-x-3">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="#3b82f6" className="flex-shrink-0 mt-0.5">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400 leading-tight">Your requests will receive priority attention in our ticketing system</p>
                </div>
              </div>

              <div className="flex items-start space-x-3">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="#10b981" className="flex-shrink-0 mt-0.5">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400 leading-tight">If it doesn't work - your refund request will be prioritized</p>
                </div>
              </div>
            </div>
          </div>
