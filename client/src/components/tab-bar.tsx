    ...
    <div className="fixed bottom-0 left-0 right-0 z-50" style={{paddingBottom: 'env(safe-area-inset-bottom)'}}>
      <div className="max-w-md mx-auto relative">
        ...
        <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-30">
          ...
          >
            <svg className="w-6 h-6 text-white fab-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                  ...
                  <div className={`mb-1 transition-all duration-300 relative z-10 ${
                    ...
                    <svg className={`w-5 h-5 transition-all duration-300 ${
                      ...
                      {tab.id === 'balance' && (
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={isActive ? 0 : 2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                      )}
                      {tab.id === 'profile' && (
