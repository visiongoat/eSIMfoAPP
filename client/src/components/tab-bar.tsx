...
export default function TabBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-white via-white to-gray-50/50 backdrop-blur-md border-t border-gray-200/60 px-2 py-1 shadow-lg shadow-gray-200/40 relative" style={{zIndex: 9999, paddingBottom: 'env(safe-area-inset-bottom)'}}>
