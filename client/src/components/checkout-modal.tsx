            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                {paymentMethods.map((method) => (
                  ...
                  >
                    <div className={`flex items-center ${method.id === 'apple-pay' ? 'space-x-2' : 'space-x-3'}`}>
                      {/* Real Payment Logos */}
                      <div className={`${method.id === 'apple-pay' ? 'w-8 h-8' : 'w-10 h-10'} flex items-center justify-center`}>
                      ...
                      <div className="text-left">
                        <div className={`font-medium ${method.id === 'apple-pay' ? 'text-white' : 'text-gray-900 dark:text-white'}`}>
                          {method.name}
                        </div>
                        {method.subtitle && (
                          <div className={`text-xs ${method.id === 'apple-pay' ? 'text-gray-300' : 'text-gray-500 dark:text-gray-400'}`}>
                            {method.subtitle}
                          </div>
                        )}
                      </div>
