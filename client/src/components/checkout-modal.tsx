                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="w-10 h-6 flex items-center justify-center">
                        {method.icon === 'apple-pay' && (
                          <div className="bg-black rounded px-2 py-1 flex items-center space-x-1">
                        ...
                        {method.icon === 'google-pay' && (
                          <div className="bg-white dark:bg-black border dark:border-gray-600 rounded px-2 py-1 flex items-center space-x-1">
                            ...
                            <span className="text-gray-900 dark:text-white text-sm font-medium">Pay</span>
                          </div>
                        )}
                        {method.icon === 'paypal' && (
                          <div className="bg-yellow-400 rounded px-2 py-1">
                            <svg className="h-4" viewBox="0 0 124 32">
                        ...
                        {method.icon === 'crypto' && (
                          <div className="bg-blue-600 rounded px-2 py-1 flex items-center space-x-1">
                            <svg className="w-4 h-4" viewBox="0 0 24 24">
                              <circle cx="12" cy="12" r="12" fill="white"/>
                              <text x="12" y="16" textAnchor="middle" fill="#0052FF" fontSize="10" fontFamily="Arial, sans-serif" fontWeight="bold">C</text>
                            </svg>
                            <span className="text-white text-sm font-medium">Pay</span>
                          </div>
                        )}
