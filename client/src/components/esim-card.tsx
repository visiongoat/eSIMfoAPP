            ...
            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 group-hover:h-2.5 transition-all duration-300 relative">
              ...
              >
                ...
                {calculateUsagePercentage() > 0 && (
                  <div 
                    className={`absolute -right-1.5 top-1/2 transform -translate-y-1/2 translate-y-0.5 w-3 h-3 rounded-full border-2 border-white dark:border-gray-800 group-hover:w-4 group-hover:h-4 transition-all duration-300 ${
